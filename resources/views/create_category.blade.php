...
<body>
    <div class="container-fluid position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="/create_category" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Add Category</a>
                    <a href="/view_all_category" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Manage Category</a>
        ...
        <div class="content">
            ...
            <form method="POST" action="/register_category" enctype="multipart/form-data">
            @csrf
