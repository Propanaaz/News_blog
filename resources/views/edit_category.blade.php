...
<body>
    <div class="container-fluid position-relative bg-white d-flex p-0">
       ...
       @foreach($category as $category)
            ...
            <form method="POST" action="/update_ads" enctype="multipart/form-data">
            @csrf
                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Edic Category</h6>
                     

                       
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="category_name" id="floatingInput"
                                    placeholder="name@example.com" value="{{$category['category_name']}}">
                                <label for="floatingInput">Category Name</label>
                                
                            </div>
                           
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="category_description" id="floatingInput"
                                    placeholder="name@example.com" value="{{$category['category_description']}}">
                            ...
                            <input type="text" name="cid" value="{{$category['id']}}" style="display: none;">
