        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-hashtag me-2"></i>Upload Post</h3>
                </a>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Edit Ads</h6>
                     

                       
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="title" id="floatingInput"
                                    placeholder="name@example.com" value="{{$ads['title']}}">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="link" id="floatingInput"
                                    placeholder="name@example.com" value="{{$ads['link']}}">
                                <label for="floatingInput">Post Link</label>
                            ...
                            <input type="text" name="aid" value="{{$ads['id']}}" style="display: none;">
