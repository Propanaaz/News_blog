                        ...
                        <div class="sidebar">
                            <div class="sidebar-widget">
                                ...
                                <div class="category">
                                    <ul class="fa-ul">
                                        @foreach($category as $category)
                                        <li><span class="fa-li"><i class="far fa-arrow-alt-circle-right"></i></span><a href="{{$category["category_name"]}}">{{$category["category_name"]}}</a></li>
                            ...
                            <div class="sidebar-widget">
                                ...
                                <div class="tags">
                                    ...
                                    <a href="{{$tag['tag_name']}}">{{$tag['tag_name']}}</a>
                                    @endforeach
