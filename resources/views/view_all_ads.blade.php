        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="/post_ads" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Create Advert</a>
                    <a href="/all_ads" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Manage Adverts</a>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$ads['title']}}</td>
                                            <td>{{$ads['link']}}</td>
                                                                                        <td><a href="edit_ads/{{$ads['id']}}" class="btn btn-primary">Update</a></td>

                                            <td><a href="delete_ads/{{$ads['id']}}" class="btn btn-danger">Delete</a></td>
